...
>(
  ...
  const {t} = useTranslation();
    ...
    const _data: readonly getAllResponse[] = getAllEntityCallback
        ...
        : getAllEntities.data?.data.items ?? [];
        ...
        typeof deleteAction === "object"
            ...
            : deleteAction === true
                ? {
                    ...
                    withConfirm: {title: t("ARE_YOU_SURE_TO_DELETE_ITEM")},
                    onClick: (record: getAllResponse) => {
                        deleteEntity.mutate({
                            id: (record as any).id,
                        });
                ...
                {viewType === "list" ? (
                    <div>
                        <Table<getAllResponse>
                            ...
                            loading={(getAllEntities.isLoading || deleteEntity.isLoading || patchEntity.isLoading || Boolean(tableProps?.loading))}
                        />
                    </div>
                ) : (
                    <>
                        {_data.length > 0 ? (
                            ...
                            <div className={styles["not-data-placeholder"]}>
                                <Spin spinning={getAllEntities.isLoading || Boolean(tableProps?.loading)}>
